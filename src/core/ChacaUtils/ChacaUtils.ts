...
import {
  ...
  MIXED_CHARACTERS,
  UPPER_CHARACTERS,
} from "../../schemas/dataType/constants/characters";
import { SPECIAL_CHARACTERS } from "../../schemas/dataType/constants/special_characters";
...
export class ChacaUtils {
   ...
   * @returns string
   */
  public replaceSymbols(text: string): string {
    let ret = "";
   ...
   * @returns string
   */
  public capitalizeCamelCase(text: string): string {
