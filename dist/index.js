...
var ChacaUtils = class {
   ...
   */
  camelCase(text) {
    return changeCaseAll.Case.camel(text);
  }
  /**
   ...
   */
  snakeCase(text) {
    return changeCaseAll.Case.snake(text);
  }
  /**
   ...
   */
  dotCase(text) {
    return changeCaseAll.Case.dot(text);
  }
  /**
   ...
   */
  sentenceCase(text) {
    return changeCaseAll.Case.sentence(text);
  }
  /**
   ...
   */
  capitalCase(text) {
    return changeCaseAll.Case.capital(text);
  }
  /**
   ...
   */
  pascalCase(text) {
    return changeCaseAll.Case.pascal(text);
  }
  /**
...
var LoremModule = class {
  ...
  slug({ wordCount } = {}) {
    ...
    const words = loremIpsum.loremIpsum({
      format: "plain",
      count: cant,
      units: "words"
    });
  ...
  words({ count: icount } = {}) {
    ...
    return loremIpsum.loremIpsum({ format: "plain", units: "words", count });
  }
  /**
   * Generates a word .
   *
   ...
   */
  word() {
    return loremIpsum.loremIpsum({ format: "plain", units: "words", count: 1 });
  }
  /**
...
var Route4 = class {
  ...
  value() {
    return `${path__default.default.join(this.base, `${this.name.value()}.${this.ext}`)}`;
  }
};
...
var NodeFileWriter = class {
  async write({
    ...
    if (location && !fs__default.default.existsSync(location)) {
      fs__default.default.mkdirSync(location, { recursive: true });
    }
    const base = path__default.default.join("./", location);
    const routes = [];
    for (const file of files) {
      const route = new Route4(new Filename(file.filename), base, ext);
      await fs__default.default.promises.writeFile(route.value(), file.content, "utf-8");
      routes.push(route);
    }
    if (zip) {
      const instance = new AdmZip__default.default();
      ...
      for (const route of routes) {
        await fs__default.default.promises.unlink(route.value());
      }
...
exports.Chaca = Chaca;
exports.ChacaError = ChacaError;
exports.ChacaModules = ChacaModules;
exports.ChacaUtils = ChacaUtils;
exports.CyclicAccessDataError = CyclicAccessDataError;
exports.Dataset = Dataset;
exports.DatasetStore = DatasetStore;
exports.EmptyEnumValuesError = EmptyEnumValuesError;
exports.EmptySequentialValuesError = EmptySequentialValuesError;
exports.EnumField = EnumField;
exports.KeyField = KeyField;
exports.NotEnoughValuesForRefError = NotEnoughValuesForRefError;
exports.NotExistRefFieldError = NotExistRefFieldError;
exports.PickField = PickField;
exports.PickFieldDefinitionError = PickFieldDefinitionError;
exports.ProbabilityField = ProbabilityField;
exports.RefField = RefField;
exports.Schema = Schema;
exports.SequenceField = SequenceField;
exports.SequentialField = SequentialField;
exports.TryRefANoKeyFieldError = TryRefANoKeyFieldError;
exports.chaca = chaca;
